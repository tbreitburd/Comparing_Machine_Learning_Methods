...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\textwidth]{../Plots/B_Q4e_1.png}
    \caption{\textbf{Feature importance}, for the 50 most important features}
\end{figure}
...
(f) Repeatsteps(b),(c)and(e)foroneothersupervisedlearningclassifier. Compare and contrast the two classification approaches and your results for each.
